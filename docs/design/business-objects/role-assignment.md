---
generated-from: design/business-objects/role-assignment/role-assignment.business-object.ts
...
|------|------|--------------|-------------|
| user | [`User`](user.md) | Belongs To | User - Assigned user |
| role | [`Role`](role.md) | References | Role - Assigned role |
