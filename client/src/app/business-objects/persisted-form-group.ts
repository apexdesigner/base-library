import { SchemaFormGroup, SchemaFormArray, SchemaFormControl } from '@apexdesigner/schema-forms';
...
const Debug = createDebug('BaseLibrary:PersistedForm');
...
export class PersistedFormGroup extends SchemaFormGroup {
  ...
  constructor(schema: SchemaType, entityClass: EntityClass, options?: PersistedFormGroupOptions, idProperty = 'id') {
    super(schema);
...
export class PersistedFormArray extends SchemaFormArray {
  ...
  constructor(itemSchema: SchemaType, entityClass: EntityArrayClass, options?: PersistedFormArrayOptions, idProperty = 'id') {
...
export class PersistedArray<T = any> extends Array<T> {
  ...
  constructor(entityClass: EntityArrayClass, options?: PersistedArrayOptions, idProperty = 'id') {
    super();
    this._entityClass = entityClass;
    this._idProperty = idProperty;
    if (options?.filter) this._filter = options.filter;
